...
<html>
    ...
    <body>
        ...
        <div class="container" style="overflow-x:auto;">
            <h1>Cadastros de Profissionais </h1>
            <div class="table">
            <br>
            <table>
                     <tr>
                     ...
                     <?php
                        ...
                        try {
                            $stmt = $pdo -> prepare('SELECT * FROM gckeeper . profissional ORDER BY nome;');
                            $stmt->execute();
                            ...
                            while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
                                echo "
                                    <tr>
                                        ...
                                        <td>{$linha['email']}</td>
                                        <td><a class='pincel' href='edi_profissional.php?id={$linha["id"]}'>
                                            ...
                                            <a class='lixo' href='del_profissional.php?id={$linha["id"]}'>
